...
public:
    ...
    {
        TitleIcon     = 0,         //左上角图标
        BtnMenuThemes = 1,         //下拉菜单按钮
        BtnMenuMin    = 2,         //最小化按钮
        BtnMenuMax    = 3,         //最大化按钮
        BtnMenuNormal = 4,         //还原按钮
        BtnMenuClose  = 5          //关闭按钮
    };
    ...
    enum Styles
    {
        StyleSilvery    = 0,       //银色样式
        StyleBlue       = 1,       //蓝色样式
        StyleLightBlue  = 2,       //淡蓝色样式
        StyleDarkBlue   = 3,       //深蓝色样式
        StyleGray       = 4,       //灰色样式
        StyleLightGray  = 5,       //浅灰色样式
        StyleDarkGray   = 6,       //深灰色样式
        StyleBlack      = 7,       //黑色样式
        StyleLightBlack = 8,       //浅黑色样式
        StyleDarkBlack  = 9,       //深黑色样式
        StylePSBlack    = 10,      //PS黑色样式
        StyleFlatBlack  = 11,      //黑色扁平样式
        StyleFlatWhite  = 12       //白色扁平样式
    };
...
public:
    ...
    //设置全局样式
    static void setStyle(QUIWidget::Styles style);
...
private:
    ...
    QLabel *labelTitle;
    QWidget *widgetMenu;
    QToolButton *btnMenuThemes;
    QPushButton *btnMenuMin;
    QPushButton *btnMenuMax;
...
public slots:
    //设置部件图标
    void setIcon(QUIWidget::TitleElements widget, QChar str, quint32 size = 9);
    void setIconMain(QChar str, quint32 size = 9);

    //设置部件图片
    void setPixmap(QUIWidget::TitleElements widget, const QString& file, const QSize& size = QSize(16, 16));

    //设置部件是否可见
    void setVisible(QUIWidget::TitleElements widget, bool visible = true);
...
public:
    ...
    static QString highlightColor;   //高亮颜色
